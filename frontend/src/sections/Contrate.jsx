    ...
    <div className="contrate-container outfit-normal">
      <div className="text-container">
        ...
        <div className="infos-container">
          <span> <MdOutlineEmail/> Soulcodejr@gmail.com</span>
          <span> <MdOutlinePhone/> (22) xxxxx-xxxx</span>
          <span> <MdOutlineLocationOn/> Av. Alberto Lamego, 2000 - Parque Califórnia, Campos dos Goytacazes - RJ</span>
        </div>
      </div>
